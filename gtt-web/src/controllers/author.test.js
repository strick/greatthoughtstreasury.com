...
describe('Author controller should return all authors', () => {
...
describe("metadata microservice", () => {
    ...
    const { startMicroservice } = require("../app"); 
    ...
    test("/author route is handled", async () => {
        ...
        expect(videosRoute).toEqual("/author");
    });
