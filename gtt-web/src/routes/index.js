...
router.get('/.well-known/acme-challenge/umDtPtH6w7ySKyL8-JjD7vN5_yoUje4iJABNZlvRFJk', function(req, res, next) {
...
router.get('/.well-known/acme-challenge/tHXmQpThj_1BmFfOhTaQKDqIpDMkrtsbdhQujb2mSUk', function(req, res, next) {
  res.set('Content-Type', 'text/plain');
